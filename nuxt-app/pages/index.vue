  ...
  <div class="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-x-10 items-center">
    ...
    <div class="relative z-10 max-w-xl">
      <h1 class="text-4xl md:text-6xl leading-tight font-extrabold text-gray-900 dark:text-white" style="overflow-wrap: break-word;">
        Spedition & Transport Renningen<br class="hidden sm:block">
        <span class="text-brand-600 dark:text-brand-400">S. Steegmüller</span>
      </h1>
       <p class="mt-4 text-lg text-gray-700 dark:text-gray-200">
         <strong>Professionelle Spedition und Express-Kurierdienst</strong> in Renningen. Umzüge, Transporte und Same-Day-Delivery nach Böblingen, Sindelfingen, Leonberg und Stuttgart – seit über 30 Jahren zuverlässig und kurzfristig verfügbar.
       </p>
       <p class="mt-2 text-gray-700 dark:text-gray-200">
         ✓ Direktfahrt ohne Umladen ✓ Express-Transport ✓ Firmenumzüge ✓ Sofort-Kurier ✓ B2B-Logistik
       </p>
    ...
    <!-- Slider -->
    <div class="relative z-0 overflow-hidden rounded-2xl shadow-lg bg-white/60 dark:bg-gray-800/60 md:h-[420px]">
     ...
     <section id="leistungen" ref="leistungenSectionRef" class="py-16 bg-white dark:bg-gray-800 fade-in-section" :class="{ 'is-visible': leistungenIsVisible }">
      <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-12">
          <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Spedition • Umzug • Express-Kurier</h2>
          <p class="text-lg text-gray-600 dark:text-gray-300">Professionelle Transport- und Logistikdienstleistungen in Renningen, Böblingen, Sindelfingen, Leonberg und Stuttgart</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center p-6 bg-gray-50 dark:bg-gray-700 rounded-xl hover-lift gradient-overlay">
            ...
            <h3 class="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Express-Transport</h3>
            <p class="text-gray-700 dark:text-gray-300 mb-4">Spedition mit Direktfahrt ohne Umladen. Ihre Ware kommt schnell und sicher ans Ziel.</p>
            <ul class="text-sm text-gray-600 dark:text-gray-300 space-y-1">
              <li>• Keine Umladungen</li>
              <li>• Direkte Lieferung</li>
          ...
          <div class="text-center p-6 bg-gray-50 dark:bg-gray-700 rounded-xl hover-lift gradient-overlay">
            ...
            <h3 class="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Firmen-Logistik</h3>
            <p class="text-gray-700 dark:text-gray-300 mb-4">B2B-Transport und regelmäßige Kurierdienste für Unternehmen im Raum Stuttgart.</p>
            <ul class="text-sm text-gray-600 dark:text-gray-300 space-y-1">
              <li>• Regelmäßige Kurierdienste</li>
              <li>• B2B Express-Service</li>
          ...
          <div class="text-center p-6 bg-gray-50 dark:bg-gray-700 rounded-xl hover-lift gradient-overlay">
            ...
            <p class="text-gray-700 dark:text-gray-300 mb-4">Komplette Umzüge und Möbeltransporte in Renningen und Umgebung. Schnell und zuverlässig.</p>
            <ul class="text-sm text-gray-600 dark:text-gray-300 space-y-1">
     ...
     <section ref="reviewsSectionRef" class="py-16 bg-white dark:bg-gray-800 fade-in-section" :class="{ 'is-visible': reviewsIsVisible }">
      <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="text-center mt-8">
          <p class="text-gray-600 dark:text-gray-300 mb-6">Familienbetrieb aus Renningen, eingespielte regionale Strecken, direkte Erreichbarkeit.</p>
     ...
     <!-- Contact Section -->
     <section id="kontakt" ref="kontaktSectionRef" class="bg-gray-100 dark:bg-gray-800 py-16 fade-in-section" :class="{ 'is-visible': kontaktIsVisible }">
      <div class="max-w-4xl mx-auto px-4">
        ...
        <!-- Formular -->
        <div class="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 hover-lift gradient-overlay">
          <h3 class="text-2xl font-bold text-center text-gray-900 dark:text-white mb-6">Anfrage senden</h3>
        <form action="https://formspree.io/f/xnnbejrl" method="POST" class="space-y-4">
          <div class="grid md:grid-cols-2 gap-4">
            <div class="relative">
              ...
              <input
                ...
                placeholder="Name *"
                required
                class="w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-brand-500/70"
              >
            </div>
            <div class="relative">
          ...
          <div class="relative">
            <ChatBubbleLeftRightIcon class="absolute left-3 top-3 h-5 w-5 text-gray-400" />
            <textarea
              name="message"
              rows="3"
          ...
          <div class="text-center">
            <button
              type="submit"
              class="group bg-brand-600 hover:bg-brand-500 text-white px-8 py-3 rounded-lg font-semibold flex items-center justify-center mx-auto transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 relative overflow-hidden"
            >
...
// Perfect SEO - Optimiert für lokale Suche
useHead({
  title: 'Spedition Renningen • Umzug • Transport • Express Kurierdienst | S. Steegmüller',
  meta: [
    { name: 'description', content: '🚛 #1 Spedition Renningen ⭐ Umzug • Transport • Express Kurier ✓ Direktfahrten Böblingen, Sindelfingen, Leonberg, Stuttgart ✓ 30+ Jahre ✓ Same Day ☎ 07159 939 61 83' },
    { name: 'keywords', content: 'Spedition Renningen, Umzug Renningen, Transport Renningen, Kurierdienst Renningen, Express Kurier Renningen, Transporte Böblingen, Umzugsservice Sindelfingen, Spedition Leonberg, Transport Stuttgart, Same Day Delivery, Direktfahrt, Expressversand, Soforttransport, Eilsendung, Firmenkurier, B2B Transport, Pakettransport, Warensendung, Logistik Baden-Württemberg, schneller Transport, zuverlässige Spedition' },
    ...
    // Open Graph
    { property: 'og:title', content: 'S. Steegmüller Transportdienstleistungen | Direktfahrten aus Renningen seit 30 Jahren' },
    { property: 'og:description', content: 'Direktfahrten ohne Umladen – seit über 30 Jahren zuverlässig in Renningen, Böblingen, Sindelfingen, Leonberg und Stuttgart. Jetzt anrufen!' },
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        "description": "Professionelle Spedition und Transportdienstleistungen in Renningen. Direktfahrten ohne Umladen nach Böblingen, Sindelfingen, Leonberg und Stuttgart. Seit über 30 Jahren pünktlich und zuverlässig.",
          ...
          "itemListElement": [
            {
              ...
              "itemOffered": {
                "@type": "Service",
                "name": "Spedition und Direkttransport",
                "description": "Professionelle Speditionsdienstleistungen mit Direktfahrten ohne Umladen von Renningen nach Böblingen, Sindelfingen, Leonberg und Stuttgart",
        ...
        "knowsAbout": ["Direktfahrten", "Sonderfahrten", "Expresszustellung", "Firmenkurierservice", "Same Day Delivery", "Logistiklösungen"],
        ...
        "slogan": "Direktfahrten ohne Umladen - seit über 30 Jahren zuverlässig",
        "keywords": "Spedition Renningen, Transport Renningen, Direktfahrt, Kurierdienst, Transportunternehmen"
      })
    }
  ]
})
