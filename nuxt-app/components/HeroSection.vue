<template>
  <section
    ...
    :class="{ 'opacity-100 translate-y-0': heroIsVisible, 'opacity-0 translate-y-12': !heroIsVisible }"
  >
    <div class="absolute inset-0 -z-10 bg-subtle-grid bg-[length:22px_22px] opacity-40 dark:opacity-20"></div>
    <div class="absolute inset-x-0 top-0 -z-20 h-48 bg-hero-gradient opacity-60 blur-3xl"></div>

    <div class="mx-auto flex max-w-6xl flex-col gap-16 px-6 md:flex-row md:items-center md:gap-12 lg:px-8">
      <div class="w-full max-w-xl space-y-8 text-left">
        <p class="text-sm font-semibold uppercase tracking-[0.35em] text-brand-600">Direktfahrten seit 1985</p>
        <h1 class="text-4xl font-bold text-neutral-900 md:text-5xl lg:text-6xl dark:text-white">
          ...
          <span class="mt-2 block text-2xl font-semibold text-brand-700 md:text-3xl dark:text-brand-400">
            Express- & Direktfahrten aus Renningen
          </span>
        </h1>
        <p class="text-lg leading-relaxed text-neutral-700 dark:text-neutral-200">
          Familienbetrieb mit fester Ansprechpartnerin, eingespielter Disposition und verlässlicher Ankunftszeit.
          Wir fahren ohne Umladen direkt von A nach B – regional rund um Böblingen, Sindelfingen, Leonberg und Stuttgart
          sowie europaweit auf Anfrage.
        </p>
        ...
        <dl class="grid gap-4 sm:grid-cols-2">
          <div class="rounded-2xl border border-neutral-200 bg-white/70 p-4 shadow-sm backdrop-blur dark:border-midnight-700 dark:bg-midnight-800/80 dark:shadow-none">
            ...
            <dd class="mt-1 text-base font-semibold text-neutral-900 dark:text-white">Start innerhalb von 90 Minuten</dd>
          </div>
          <div class="rounded-2xl border border-neutral-200 bg-white/70 p-4 shadow-sm backdrop-blur dark:border-midnight-700 dark:bg-midnight-800/80 dark:shadow-none">
            <dt class="flex items-center gap-2 text-sm font-medium text-neutral-500 dark:text-neutral-300">
          ...
          <div class="rounded-2xl border border-neutral-200 bg-white/70 p-4 shadow-sm backdrop-blur dark:border-midnight-700 dark:bg-midnight-800/80 dark:shadow-none">
            ...
            <dd class="mt-1 text-base font-semibold text-neutral-900 dark:text-white">Renningen · Böblingen · Sindelfingen · Leonberg</dd>
          </div>
          <div class="rounded-2xl border border-neutral-200 bg-white/70 p-4 shadow-sm backdrop-blur dark:border-midnight-700 dark:bg-midnight-800/80 dark:shadow-none">
            <dt class="flex items-center gap-2 text-sm font-medium text-neutral-500 dark:text-neutral-300">
            ...
            <dd class="mt-1 text-base font-semibold text-neutral-900 dark:text-white">Fahrzeuge bis 1.5 t Nutzlast</dd>
          </div>
        </dl>
        ...
        <div class="flex flex-col items-start gap-4 sm:flex-row sm:items-center">
           ...
           >
             ...
             0172 755 20 23
             <span class="absolute inset-0 rounded-full border border-white/20 opacity-0 transition group-hover:opacity-100"></span>
           </a>
          <NuxtLink
            to="#kontakt"
