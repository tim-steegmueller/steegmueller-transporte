<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <header class="site-header">
      ...
      >
        <div
          class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center gap-3 text-amber-900 dark:text-amber-100"
        >
          <svg
          ...
          >
            <path
              fill-rule="evenodd"
              d="M8.257 3.099c.765-1.36 2.72-1.36 3.485 0l6.518 11.595c.75 1.335-.213 2.991-1.742 2.991H3.481c-1.53 0-2.492-1.656-1.742-2.99L8.257 3.1zM11 14a1 1 0 10-2 0 1 1 0 002 0zm-1-2a.75.75 0 01-.75-.75V7.25a.75.75 0 011.5 0v3.999A.75.75 0 0110 12z"
              clip-rule="evenodd"
            />
          </svg>
          <p class="text-sm sm:text-[15px]">
            Hinweis: Diese Website befindet sich im Aufbau. Inhalte werden laufend ergänzt. Bei
            Anfragen bitte direkt anrufen:
            <a
              class="font-semibold underline decoration-amber-500/60 hover:decoration-amber-500"
        ...
        <div class="flex items-center justify-between gap-4 py-6">
          <NuxtLink to="/" class="flex items-center gap-6 group">
            ...
            <div class="hidden sm:flex flex-col leading-tight">
              <span
                class="text-xl font-bold text-gray-900 dark:text-white group-hover:text-brand-600 transition-colors"
                >S. Steegmüller</span
              >
              <span class="text-base text-gray-600 dark:text-gray-300 font-medium"
          ...
          <div class="flex items-center gap-2">
            ...
            <div class="hidden md:flex items-center gap-2 lg:gap-3">
              <a href="tel:+4971599396183" class="cta-button call">
            ...
            >
              ...
              <div class="relative h-6 w-6">
                <span
                  class="mobile-bar"
                  :class="{ 'translate-y-[10px] rotate-45': isMobileMenuOpen }"
                />
                <span class="mobile-bar" :class="{ 'opacity-0': isMobileMenuOpen }" />
                <span
                  class="mobile-bar"
                  :class="{ '-translate-y-[10px] -rotate-45': isMobileMenuOpen }"
                />
      ...
      <transition name="mobile-fade">
        <div v-if="isMobileMenuOpen" class="mobile-nav">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
            ...
            <div
              class="flex items-center justify-between rounded-2xl bg-gray-100 dark:bg-gray-800 px-4 py-3"
            >
              <div>
                <p class="text-sm font-semibold text-gray-700 dark:text-gray-200">Darstellung</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ isDark.value ? 'Dunkler Modus aktiv' : 'Heller Modus aktiv' }}
                </p>
              </div>
              <button
                class="dark-toggle"
    ...
    <footer class="bg-gray-900 text-white py-8">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p class="text-gray-300 mb-4">
              Telefon:
              <a href="tel:+491727552023" class="text-brand-400 hover:text-brand-500"
                >0172 755 20 23</a
              ><br />
              Büro:
              <a href="tel:+4971599396183" class="text-brand-400 hover:text-brand-500"
                >07159 939 61 83</a
              ><br />
              E-Mail:
              <a href="mailto:wswsteegmueller@gmail.com" class="text-brand-400 hover:text-brand-500"
                >wswsteegmueller@gmail.com</a
              >
            </p>
            <a
        ...
        <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p class="mb-2">
            &copy; 2025 S. Steegmüller Transportdienstleistungen. Alle Rechte vorbehalten.
          </p>
          <div class="flex items-center justify-center gap-4">
            <NuxtLink to="/datenschutz" class="hover:text-white">Datenschutz</NuxtLink>
            <button type="button" class="underline hover:text-white" @click="openConsent">
              Cookie‑Einstellungen
            </button>
            <span
              v-if="mapsConsent !== null"
              class="inline-flex items-center rounded-full px-2 py-0.5 text-xs"
              :class="
                mapsConsent
                  ? 'bg-green-600/20 text-green-200 ring-1 ring-green-500/40'
                  : 'bg-yellow-600/20 text-yellow-200 ring-1 ring-yellow-500/40'
              "
            >
    ...
    <div class="fixed bottom-6 right-6 z-50 flex flex-col space-y-3">
      ...
      <a href="tel:+4971599396183" class="floating-button call" title="Jetzt anrufen">
...
onMounted(() => {
  try {
    showBuildBanner.value = localStorage.getItem(BANNER_KEY) !== 'true'
  } catch (e) {}
})
</script>
